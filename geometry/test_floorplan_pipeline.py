            ...
            "staging_objects": [
                {
                    ...
                    "type": "staging_box",
                    "name": "Sofa testowa",
                    "origin_m": [0.90, 2.05, 0.0],
                    "size_m": [1.90, 0.78, 0.72],
                    "material_id": "fabric_olive_test",
                    "status": "TEST_STAGING",
                },
                {
                ...
                },
                {
                    ...
                    "type": "staging_box",
                    "name": "Dywan testowy",
                    "origin_m": [1.10, 1.15, 0.0],
                    "size_m": [2.35, 1.45, 0.025],
                    "material_id": "rug_sand_test",
                    "status": "TEST_STAGING",
                },
                {
                    "id": "test-accent-chair",
                    "type": "staging_box",
                    "name": "Fotel testowy",
                    "origin_m": [3.35, 1.70, 0.0],
                    "size_m": [0.72, 0.72, 0.78],
                    "material_id": "fabric_terracotta_test",
                    "status": "TEST_STAGING",
                },
            ],
